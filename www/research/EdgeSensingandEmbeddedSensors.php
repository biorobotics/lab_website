...
============================= -->
	...
	<div class="row"><h3 class="c27" id="h.xd55dffb80qi"><b><span class="c16">Confined Space Robotics</b> - Edge Sensing and Embedded Sensors </span></h3><p class="c0"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 230.00px; height: 163.00px;"><img alt="" src="images/EdgeSensingandEmbeddedSensors/image81.png" style="width: 230.00px; height: 163.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c0"><span class="c3 c1">Confined space applications require specialized 3D sensors to scan the environment, detect objects, and avoid obstacles. Compared to mainstream sensors being widely used among the robotics community, such as Lidar and machine vision cameras, 3D sensors for confined spaces have additional requirements on the miniature size, ultra-short sensing ranges, and high accuracy.</span></p><p class="c0 c13"><span class="c3 c1"></span></p><p class="c0"><span class="c3 c1">There are no COTS solutions available to fulfill the ultra-short-range but high-precision 3D perception challenge. Most of the commercially available sensor systems are bulky, &ldquo;farsighted&rdquo;, and require external computers to perform 3D processing. It would be difficult to even obtain and let alone miniaturize an integrated sensor system, and through our work, we have developed a deep insight into creating these sensors and intelligently processing information from these sensors. The Boeing-CMU team has developed several working prototypes of miniature 3D sensors which are well-suited to confined space manufacturing and inspection applications. The job is not done and hence the CMU team is actively working on improving the hardware performance and software efficiency, and aim to make the sensor (Blaser) become the best option for short-range industrial robotic perception solutions for all applications.</span></p><p class="c0"><span class="c3 c1">We also must note that most 3D sensors are not robot-ready, they only output raw sensor reading and have no awareness of its host robotic system. In contrast, a robotic enabled sensor should output a command signal to trigger the robot to perform a search or an avoidance maneuver, and simultaneously localize the robot in the environment and generate the 3D map of the surroundings. The Blaser sensor is capable of directly generating and processing 3D point cloud information onboard while providing direct high-level feedback or even command to any ROS-enabled or other robotic systems.</span></p><p class="c0 c13"><span class="c3 c1"></span></p><p class="c0"><span class="c3 c1">Publication:</span></p><p class="c0"><span class="c3 c1">D. Cheng, H. Shi, A. Xu, M. Schwerin, M. Crivella, L Li, H. Choset, Visual-Laser-Inertial SLAM Using a Compact 3D Scanner for Confined Space. Conference Paper, IEEE ICRA 2021 Conference, May 2021</span></p><p class="c0 c13"><span class="c3 c1"></span></p><p class="c0"><span class="c3 c1">D. Cheng, H. Shi, M. Schwerin, M. Crivella, L. Li, and H. Choset, A Compact and Infrastructure-free Confined Space Sensor for 3D Scanning and SLAM. Conference Paper, IEEE SENSOR 2020 Conference, Oct 2020</span></p><p class="c0 c13"><span class="c3 c1"></span></p><p class="c0 c13"><span class="c3 c1"></span></p><p class="c0"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 334.67px;"><img alt="" src="images/EdgeSensingandEmbeddedSensors/image68.png" style="width: 624.00px; height: 334.67px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c0"><span class="c31 c43 c1"><a class="c24" href="https://www.google.com/url?q=https://drive.google.com/file/d/1XBK_jUuNg8tLgewcx3wj7nQiMG3YevfS/view&amp;sa=D&amp;source=editors&amp;ust=1671230812242877&amp;usg=AOvVaw2EsrtrMMaACe4Swj4ft1t4">https://drive.google.com/file/d/1XBK_jUuNg8tLgewcx3wj7nQiMG3YevfS/view</a></span></p><p class="c0 c13"><span class="c3 c1"></span></p><hr style="page-break-before:always;display:none;"><!-- <div class="six columns">
