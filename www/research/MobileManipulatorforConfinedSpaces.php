...
============================= -->
	<title>Mobile Manipulator for Confined Spaces - Biorobotics</title>
	<meta name="Keywords" content="Carnegie Mellon University, robotics, Confined Space Robotics">
	<meta name="description" content ="Mobile Manipulator for Confined Spaces - Carnegie Mellon Biorobotics" /><!-- Banner and Menu - Do not change
============================= -->
...
============================= -->
	...
	<div class="row"><h3 class="c20" id="h.ahbhv3u9f90p"><b><span class="c15">Confined Space Robotics</b> - Mobile Manipulator for Confined Spaces</span></h3><p class="c18"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 240.00px; height: 240.00px;"><img alt="" src="images/MobileManipulatorforConfinedSpaces/image44.png" style="width: 240.00px; height: 240.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c30"><span class="c16 c35">This project seeks to design and develop specialized mobile robots for confined space inspection and manufacturing to replace humans to perform dangerous and hazardous works. Besides, we are also particularly interested in confined space perception and SLAM problems. Several demonstration platforms have been built over the last decades, and our lab is also actively collaborating with industrial partners to provide the revolutionary robotic solution for real-world confined space problems.</span></p><p class="c18"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 336.00px;"><img alt="" src="images/MobileManipulatorforConfinedSpaces/image19.png" style="width: 624.00px; height: 336.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c57 c51"><span class="c4"></span></p><p class="c12"><span class="c4"></span></p><p class="c30"><span class="c5">Developing a highly reliable and robust real-time control robotic system for confined space manufacturing application requires a cross-disciplinary knowledge of mechatronics, signal processing, control theory, communication and computer science. The CMU team has decades of experience in designing and perfecting custom robotic arm, manipulator, sensor, and its control hardware/software for confined space applications. The CMU Biorobotics lab is one of the most active academic groups whose research and practice includes hyper-redundant novel mechanism design, real-time embedded electronics, bio-inspired perception &amp; control, path-planning, SLAM and other theoretical research in robotics.</span></p><p class="c57"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 461.50px; height: 255.16px;"><img alt="" src="images/MobileManipulatorforConfinedSpaces/image10.png" style="width: 461.50px; height: 255.16px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c30"><span class="c5">The CMU biorobotics lab specialized in design and development of the robotic system which combines real-time embedded system and hybrid real-time Linux with interfaces to traditional ROS or ROS-like software stack, able to closed-loop control a custom designed redundant robotic arm. The ongoing project will keep improving the system performance which enables the non-real-time ROS system to effortlessly interface with high timing critical and low latency hardware.</span></p><p class="c12"><span class="c5"></span></p><p class="c30"><span class="c13">Currently, we are working on a multi-modal approach of combining high-accuracy dense 3D sensor (Blaser), distributed sparse 1D rangefinder (miniature Time-of-Flight ICs), and joints load proprioception(Motor current and back-EMF feedback), to facilitate obstacle avoidance capability to our confined space robotic arm. Furthermore, obstacle and object information also will be tightly included as part of the SLAM and path planning frameworks, to improve dynamic replanning, and online map update.</span></p><hr style="page-break-before:always;display:none;"><p class="c10 c51"><span class="c4"></span></p><p class="c10"><span class="c29"><a class="c24" href="#h.jpmbcvqkcs3b">[Home]</a></span></p><!-- <div class="six columns">
