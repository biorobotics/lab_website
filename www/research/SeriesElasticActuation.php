...
============================= -->
	...
	<div class="row"><h3 class="c27" id="h.6jf5w38exja3"><b><span class="c16">Locomoting Systems</b> - Series Elastic Actuation</span></h3><p class="c10"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 624.00px; height: 160.00px;"><img alt="" src="images/SeriesElasticActuation/image32.png" style="width: 624.00px; height: 160.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c36"><span class="c5 c8">The small cross section and wide range of motion of our snake robots allow them to navigate many diverse environments, such as rough ground, channels, pipes, poles, and trees. This makes them applicable to a diverse set of tasks such as urban search and rescue, mine rescue, industrial inspection, and reconnaissance. In all of these situations, the ability to adapt and comply to the environment is paramount.</span></p><p class="c36"><span class="c5 c8">Our snake robots are similar to most other mobile robots in that they rely on highly-geared electric motors for actuation, - providing large torques at slow speeds. The modules of our latest robot use a brushed DC motor and a 400:1 gear train to produce peak torques of over 2.7 N-m (2 ft-lbs) and a maximum speed of 30 rpm. While this design makes the robot extremely capable of executing its commanded motions, the stiffness of the actuators makes sensing contact with the environment difficult.</span></p><p class="c10 c76"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 500.00px; height: 394.00px;"><img alt="Hysteresis" src="images/SeriesElasticActuation/image71.jpg" style="width: 500.00px; height: 394.00px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c36"><span class="c8 c19">Theoretically, each module can estimate its output torque by measuring the current drawn by its motor, but in practice this is very difficult. Nonlinear effects like the friction, stiction, and reflected inertia of the gear train frequently cause the measured current to be significantly different from the actual torque at the output hub of the module. Adding series elasticity to our modules has the potential to mitigate these problems [1] as well as provide an easy and accurate estimate of the actuator&#39;s output torque, assuming the actuator has a relatively linear spring constant.</span></p><p class="c36"><span class="c5 c8">However, incorporating series elasticity into such a high-performance robot is not a trivial task. In order to be used in our snake robots, the series elastic element needs to have excellent energy storage and ultimate strength, fit in an extremely small design space, and be able to be manufactured reliably in large quantities (our lab currently has 60 snake modules). This work details the design, fabrication, and modeling of a high-performance series elastic element that torsionally shears rubber between two rigid plates. We show that this design meets all of the above design criteria, and that the spring characteristics can be modeled well enough to enable accurate torque sensing in future robots.</span></p><p class="c36"><span class="c38 c11 c28 c42">[1] G. Pratt and M. Williamson, &quot;Series elastic actuators,&quot; Proceedings 1995 IEEE/RSJ International Conference on Intelligent Robots and Systems., pp. 399-406, 1995.</span></p><hr style="page-break-before:always;display:none;"><p class="c10 c13"><span class="c18 c1"></span></p><p class="c35"><span class="c31 c43"><a class="c24" href="#h.jpmbcvqkcs3b">[Home]</a></span></p><h1 class="c12" id="h.wq6beigfh84u"><span class="c3 c20">CONFINED SPACE ROBOTICS</span></h1><!-- <div class="six columns">
