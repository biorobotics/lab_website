...
============================= -->
	...
	<div class="row"><h3 class="c27" id="h.oi7foe6tqqhp"><b><span class="c16">Medical Robotics</b> - Autonomous Force-controlled Ultrasound Scanning</span></h3><p class="c10 c13"><span class="c1 c18"></span></p><p class="c10"><span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 314.50px; height: 178.14px;"><img alt="" src="images/AutonomousForcecontrolledUltrasoundScanning/image55.png" style="width: 314.50px; height: 178.14px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title=""></span></p><p class="c10"><span class="c3 c1">In the case of high-tempo, traumatic scenarios on the battlefield, real-time ultrasound (US) imaging serves as an enabler for countless possible robotic interventions. Ultrasound has the benefit of being &nbsp;low-cost, portable, and radiation-free. The problem with ultrasound is that it is often difficult to interpret, therefore making interventions even more difficult, both for human caregivers and medical AI that supports them. This project aims to enable robotic-based ultrasound scanning with minimal human help. The challenge is divided into two parts: </span></p><p class="c10 c13"><span class="c3 c1"></span></p><p class="c10"><span class="c3 c1">1. How to scan a curved/non-flat surface with proper ultrasound contact with the surface? </span></p><p class="c10 c13"><span class="c3 c1"></span></p><p class="c10"><span class="c3 c1">2. How to find the best location/trajectory to scan given the target without human-in-loop? </span></p><p class="c10 c13"><span class="c3 c1"></span></p><p class="c10"><span class="c3 c1">To solve the first question, we are looking to combine the force feedback with the prior knowledge of the surface to maintain maximum acoustic coupling and scan the target. We use commonly used metrics such as image noise and NCC score to quantify the scanning process. &nbsp;For the second part of the problem we are using Bayesian optimization to find the best location/trajectory on &nbsp;an unknown skin surface for needle insertion. Apart from the unknown surface geometry, other challenges in this &nbsp;include keeping the ultrasound normal to the surface to get a good image and using optimal force to press the probe on the surface such that the vessels don&rsquo;t get deformed or injure the soldier. Furthermore, we are also working to create a simulation version of ultrasound scanning where we can test our algorithm in simulation before deploying on the real robot. The steps in this include a 3D volume reconstruction from ultrasound scans as well as pairing it with a physics engine for deformation modeling/control. </span></p><p class="c10 c13"><span class="c3 c1"></span></p><p class="c0"><span class="c25 c1">Relevant Publications:</span></p><p class="c0 c13"><span class="c38 c19 c28 c42 c21 c58"></span></p><p class="c0"><span class="c19 c1 c21">Goel, Raghavv, et al. &quot;Autonomous Ultrasound Scanning using Bayesian Optimization and Hybrid Force Control.&quot; </span><span class="c19 c1 c21 c22">2022 International Conference on Robotics and Automation (ICRA)</span><span class="c19 c1 c21">. IEEE, 2022.</span></p><p class="c0 c13"><span class="c25 c1"></span></p><hr style="page-break-before:always;display:none;"><!-- <div class="six columns">
